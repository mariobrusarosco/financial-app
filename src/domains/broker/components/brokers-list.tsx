...
const LoadingState = () => {
  return (
    <div data-testid="brokers-loading" className="text-center py-8">
...
const BrokersList = () => {
  ...
  return (
    <ul data-testid="brokers-list" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3 p-6">
      {brokers.map(broker => (
        <li key={broker.id}>
