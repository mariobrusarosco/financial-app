...
export const CompactCalculator = ({ onApply, onClose, initialValue }: CompactCalculatorProps) => {
  ...
  return (
    <div className="p-4 border rounded-md bg-card shadow-sm w-full max-w-[320px]">
