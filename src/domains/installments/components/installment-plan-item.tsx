        ...
        <div className="flex items-center gap-4 cursor-pointer flex-1" onClick={() => setIsExpanded(!isExpanded)}>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground mt-1">
              ...
              <span>{plan.num_installments} installments</span>
            ...
            <div className="mt-3 space-y-1">
              <div className="flex justify-between text-xs">
                <span className="text-muted-foreground">Progress: {paidInstallments}/{plan.num_installments}</span>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
              {plan.installments.map((installment) => (
                <div key={installment.id} className="p-2 border rounded-md bg-card text-xs flex justify-between items-center">
                  <div>
